  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        {/* Brand */}
        <a href="#" className="flex items-center gap-2 font-mono text-sm tracking-widest text-zinc-100 hover:text-blue-400 transition-colors">
        ...
        <div className="hidden md:flex items-center gap-3">
          <button 
            ...
            className="flex items-center gap-2 px-3 py-1.5 rounded-md border border-white/10 bg-white/5 text-[10px] font-mono text-zinc-400 hover:bg-white/10 hover:text-zinc-100 transition-all cursor-pointer"
          >
          ...
          <button 
            ...
            className="flex items-center gap-2 px-3 py-1.5 rounded-md border border-blue-500/20 bg-blue-500/5 text-[10px] font-mono text-blue-400 hover:bg-blue-500/10 hover:text-blue-300 transition-all cursor-pointer"
          >
        ...
        <div className="flex md:hidden items-center gap-3">
          <button
            onClick={onCommandPaletteToggle}
            className="p-1.5 rounded-md border border-white/10 bg-white/5 text-zinc-400 hover:text-zinc-100"
          >
      ...
      {/* Mobile Drawer */}
      {mobileMenuOpen && (
        <div className="md:hidden absolute top-full left-0 w-full bg-[#030303]/95 border-b border-white/10 py-6 px-6 backdrop-blur-lg flex flex-col gap-5 text-sm font-mono tracking-widest text-zinc-400">
          <a href="#projects" onClick={() => setMobileMenuOpen(false)} className="hover:text-zinc-100 transition-colors">PROJECTS</a>
          <a href="#architecture" onClick={() => setMobileMenuOpen(false)} className="hover:text-zinc-100 transition-colors">ARCHITECTURE</a>
          <a href="#skills" onClick={() => setMobileMenuOpen(false)} className="hover:text-zinc-100 transition-colors">SKILLS</a>
          <a href="#playground" onClick={() => setMobileMenuOpen(false)} className="hover:text-zinc-100 transition-colors">PLAYGROUND</a>
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 py-2 rounded-md border border-blue-500/20 bg-blue-500/5 text-blue-400 text-xs hover:bg-blue-500/10 cursor-pointer"
            >
